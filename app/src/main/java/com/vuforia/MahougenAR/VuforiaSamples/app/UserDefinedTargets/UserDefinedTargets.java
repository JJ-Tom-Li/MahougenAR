...
package com.vuforia.MahougenAR.VuforiaSamples.app.UserDefinedTargets;
...
import com.vuforia.MahougenAR.SampleApplication.SampleApplicationControl;
import com.vuforia.MahougenAR.SampleApplication.SampleApplicationException;
import com.vuforia.MahougenAR.SampleApplication.SampleApplicationSession;
import com.vuforia.MahougenAR.SampleApplication.utils.LoadingDialogHandler;
import com.vuforia.MahougenAR.SampleApplication.utils.SampleApplicationGLView;
import com.vuforia.MahougenAR.SampleApplication.utils.Texture;
import com.vuforia.MahougenAR.VuforiaSamples.R;
import com.vuforia.MahougenAR.VuforiaSamples.ui.SampleAppMenu.SampleAppMenu;
import com.vuforia.MahougenAR.VuforiaSamples.ui.SampleAppMenu.SampleAppMenuGroup;
import com.vuforia.MahougenAR.VuforiaSamples.ui.SampleAppMenu.SampleAppMenuInterface;
    ...
    SampleApplicationControl, SampleAppMenuInterface
{
    ...
    private void loadTextures()
    {
        ...
        //   getAssets()));
        /**First get the image name from the intent.
         * */
        ...
        //Trying to turn the image into texture and add it into mTextures.
        try{
    ...
    {
        /**Turn the bitmap into Texture
         * This code is copy from the below web:
         * https://developer.vuforia.com/forum/faq/android-how-do-i-add-textures-my-model
         * Make a little change(Format change) to the code.*/
        ...
        texture.mChannels = 4;
        texture.mData = ByteBuffer.wrap(dataBytes);
